...
class OnlineTest extends JFrame implements ActionListener {
	...
	void set() {
		...
		if (current == 0) {
			label.setText("Que1:  Which of the following is not a JAVA Feature ?");
			radioButton[0].setText("Dynamic");
			radioButton[1].setText("Artitecture Neutral");
			radioButton[2].setText("Use of Pointers");
			radioButton[3].setText("Object-Oriented");
		}
		if (current == 1) {
			label.setText("Que2:  ____ is used to find and fix bugs in the Java programs.");
		...
		if (current == 2) {
			label.setText("Que3: What is the return type of the hashCode() method in the Object class?");
		...
		if (current == 3) {
			label.setText("Que4: What does the expression float a = 35 / 0 return?");
		...
		if (current == 4) {
			label.setText("Que5: Which of the following is not an OOPS concept in Java? ");
			radioButton[0].setText(" Inheritence");
			radioButton[1].setText("Encapsulation");
			radioButton[2].setText("Compilation");
			radioButton[3].setText("Polymorphism");
		}
		if (current == 5) {
			label.setText("Que6: How many reserved keywords are currently defined in the Java language?");
			radioButton[0].setText("48");
			radioButton[1].setText("49");
			radioButton[2].setText("50");
			radioButton[3].setText("47");
		}
		if (current == 6) {
